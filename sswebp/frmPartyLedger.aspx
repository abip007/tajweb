<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmPartyLedger.aspx.cs" Inherits="WebApplication2.frmPartyLedger" %>
    ...
    <div>
        ...
        <asp:ScriptManager ID="ScriptManager1" runat="server">
         ...
         <div>
            ...
            MemberId <asp:TextBox ID="TextBox3" runat="server"></asp:TextBox>
