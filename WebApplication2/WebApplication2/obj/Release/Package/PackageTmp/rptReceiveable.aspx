<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptReceiveable.aspx.cs" Inherits="WebApplication2.rptReceiveable" %>
...
<body>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
         ...
         <div>
             ...
             <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="500px" Width="696px">
             </rsweb:ReportViewer>
